<x-guest-layout>
    ...
    -webkit-text-emphasis-position: under;">RSN</span><span style="color:#0275d8;">A</span><span>BLISS</span>&nbsp;
        ...
        <h4 class="text-center" style="font-weight:bold; font-size: 1.5em; margin: 10px 0 15px 0;">Admin Login</h4>
        <hr>

        <form method="POST" action="{{ route('admin.login') }}" style="margin-top: 15px">
            @csrf
